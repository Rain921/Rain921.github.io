var preloader = new GSPreloader({
  ...
  dotSize:15,
  dotCount:10,
  colors:["#dd6400","#f6aa00","#ffc500"], //have as many or as few colors as you want.
  boxOpacity:0,
  animationOffset: 0.8, //jump 1.8 seconds into the animation for a more active part of the spinning initially (just looks a bit better in my opinion)
});
